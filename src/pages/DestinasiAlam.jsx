    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="bg-white top-0 z-10 px-4 py-4 mb-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between max-w-7xl mx-auto">
          <div><h1 className="text-2xl md:text-3xl font-bold text-gray-900 inline-block border-b-2 border-teal-100 pb-2">Destinasi Alam</h1></div>
      ...
      <div className="px-4 max-w-7xl mx-auto">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          {!loading && visibleDestinations.length === 0 && <div className="text-center text-gray-500 mt-10 col-span-full py-10 bg-white rounded-xl border border-dashed border-gray-300"><p>Tidak menemukan wisata alam yang cocok.</p><p className="text-sm mt-1">Coba ubah kata kunci atau urutan.</p></div>}
        </div>
      </div>
    </div>
  );
